...
const NotificationCenter = ({ isOpen, onClose }) => {
  ...
  const getPriorityColor = (priority) => {
    switch (priority) {
      case 5: return 'var(--error)'; // Critical
      case 4: return 'var(--error)'; // Urgent
      case 3: return 'var(--warning)'; // High
      case 2: return 'var(--info)'; // Normal
      default: return 'var(--text-muted)'; // Low
    }
  };
    ...
    >
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          <FiBell size={20} style={{ color: 'var(--text-secondary)' }} />
          <h3 style={{
            margin: 0,
            fontSize: 16,
            fontWeight: 600,
      ...
      <div style={{
        ...
        {loading ? (
          ...
          <div style={{
            ...
            <FiBell size={48} style={{ marginBottom: 16, opacity: 0.5 }} />
          ...
          notifications.map((notification) => (
            <div
              ...
              style={{
                ...
                backgroundColor: notification.is_read ? 'transparent' : 'var(--bg-hover)',
                cursor: 'pointer',
